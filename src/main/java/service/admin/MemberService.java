...
public interface MemberService {
	...
	List<MemberDTO> trainerList(PageInfo pageInfo, String trainerName) throws Exception;
	List<MemberDTO> clientList(PageInfo pageInfo, String clientName) throws Exception;
