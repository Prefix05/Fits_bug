...
<thead class="sticky top-0 bg-surface-container-lowest z-10">
<tr class="bg-surface-container-low/50">
<th class="px-6 py-4 text-xs font-bold text-on-surface-variant uppercase tracking-wider">트레이너명</th>
<th class="px-6 py-4 text-xs font-bold text-on-surface-variant uppercase tracking-wider">회원명</th>
<th class="px-6 py-4 text-xs font-bold text-on-surface-variant uppercase tracking-wider">배정일자</th>
<th class="px-6 py-4 text-xs font-bold text-on-surface-variant uppercase tracking-wider">이용권 정보</th>
<th class="px-6 py-4 text-xs font-bold text-on-surface-variant uppercase tracking-wider">남은 횟수/기간</th>
<th class="px-6 py-4 text-xs font-bold text-on-surface-variant uppercase tracking-wider">현재 현황</th>
</tr>
</thead>
<tbody class="divide-y divide-surface-container">
<c:forEach var="assign" items="${assignList}">
<tr class="hover:bg-surface-container-low/30 transition-colors">
	<td class="px-6 py-4 text-sm font-bold text-primary">${assign.trainerName}</td>
            ...
            data.forEach(member => {
                html += `
                    <tr>
                        ...
                        <td>\${member.remainingSession}회</td>
