    ...
    <div class="max-w-4xl mx-auto p-6 md:p-8">
        ...
        <div class="space-y-6">
            ...
            <section class="bg-surface-container-lowest rounded-[2rem] overflow-hidden border border-surface-variant/30 shadow-sm">
                <!-- Banner -->
                <div class="h-40 md:h-48 w-full primary-gradient bg-gradient-to-r from-blue-600 to-blue-400"></div>
                            ...
                            <div class="pt-1 space-y-2">
                                <div class="flex items-center flex-wrap gap-2">
                                    ...
                                    <c:if test="${trainer.approvalStatus == 'APPROVED'}">
                                        <span class="flex items-center gap-1 px-3 py-0.5 rounded-full bg-emerald-50 text-emerald-600 text-[10px] font-bold uppercase tracking-wider border border-emerald-100"
                                              title="플랫폼 인증 트레이너">
                                            <span class="material-symbols-outlined text-xs" style='font-variation-settings: "FILL" 1;'>workspace_premium</span>인증 트레이너
                                        </span>
                                    </c:if>
                                    <%-- Trainer type label --%>
                                    <c:choose>
